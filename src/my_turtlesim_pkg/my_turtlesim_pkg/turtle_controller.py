...
class TurtleControllerNode(Node):
    def __init__(self):
        ...
        self.turtles_alive_subscriber_ = self.create_subscription(TurtleArray, "/alive_turtles", self.callback_alive_turtles, 10)
    ...
    def callback_call_catch_turtle_service(self, future, turtle_name):
        ...
        if not response.success:
            self.get_logger().info("Turtle " + turtle_name + " could not be removed ") 
